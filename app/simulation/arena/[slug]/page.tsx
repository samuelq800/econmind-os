...
export default async function SimulationChallengePage({ params }: { params: Promise<{ slug: string }> }) {
  const { slug } = await params;
  return <LeagueChallengeBrief slug={slug} basePath="/simulation/arena" />;
}

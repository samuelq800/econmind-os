...
export const metadata: Metadata = { title: "Privacy Notice", description: "How EconMind OS handles account, optional Google Sign-In, learning, and community information." };

...
export const LIVE_WORLD_POLICY_CONTROLS: readonly LiveWorldPolicyControl[] = [
  { key: "policy_rate", role: "central_bank_governor", label: "Policy rate", description: "Balances price control against credit and activity.", min: 0, max: 15, step: 0.5, defaultValue: 5, unit: "%" },
  { key: "liquidity_support", role: "central_bank_governor", label: "Liquidity support", description: "Temporary credit support for the financial system.", min: 0, max: 30, step: 1, defaultValue: 8 },
  { key: "reserve_requirement", role: "central_bank_governor", label: "Reserve requirement", description: "Bank reserve buffer that moderates lending risk.", min: 0, max: 25, step: 1, defaultValue: 10, unit: "%" },
  { key: "government_spending", role: "finance_domestic_minister", label: "Government spending", description: "Near-term demand and public-service capacity.", min: 0, max: 65, step: 1, defaultValue: 32 },
  { key: "tax_rate", role: "finance_domestic_minister", label: "Tax rate", description: "Revenue resilience versus household and business demand.", min: 5, max: 50, step: 1, defaultValue: 22, unit: "%" },
  { key: "welfare", role: "finance_domestic_minister", label: "Welfare support", description: "Protects livelihoods while using fiscal room.", min: 0, max: 40, step: 1, defaultValue: 14 },
  { key: "infrastructure", role: "finance_domestic_minister", label: "Infrastructure", description: "Builds capacity with a delayed fiscal trade-off.", min: 0, max: 50, step: 1, defaultValue: 18 },
  { key: "tariff", role: "trade_industry_investment_minister", label: "Tariff", description: "Protects domestic producers but raises import costs.", min: 0, max: 40, step: 1, defaultValue: 8, unit: "%" },
...
export const LIVE_WORLD_CRISIS_LIBRARY: readonly LiveWorldCrisis[] = [
  { id: "energy-price-spike", label: "Energy price spike", description: "Global energy costs rise sharply, testing import dependence and resource buffers.", affectedCountries: ["aurora", "borealis", "demeria"], effects: { activity: -4, prices: -8, fiscal: -2, stability: -3 }, active: true },
  { id: "capital-flight", label: "Capital flight", description: "External investors reduce risk exposure, testing financial depth and capital dependence.", affectedCountries: ["cyrenia", "demeria"], effects: { financial: -9, activity: -4, stability: -4 }, active: true },
  { id: "supply-chain-disruption", label: "Supply-chain disruption", description: "Trade logistics slow, challenging export-oriented manufacturing systems.", affectedCountries: ["borealis", "aurora"], effects: { activity: -7, livelihoods: -3, prices: -3 }, active: true },
  { id: "commodity-boom", label: "Commodity boom", description: "Resource prices rise, creating gains but inflation and concentration risks.", affectedCountries: ["cyrenia"], effects: { activity: 7, fiscal: 6, prices: -3, stability: -1 }, active: true },
] as const;

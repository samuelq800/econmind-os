...
export function environmentalContributions(parameters: SandboxParameters): PolicyContribution[] {
  return [
    ...
    { policy: "carbonTax", label: "Carbon tax", values: { gdpIndex: -0.04 * parameters.carbonTax, governmentRevenue: 0.25 * parameters.carbonTax, consumerWelfare: 0.08 * parameters.carbonTax, firmProfit: -0.12 * parameters.carbonTax, carbonEmissions: -0.6 * parameters.carbonTax, marketOutput: -0.04 * parameters.carbonTax } },

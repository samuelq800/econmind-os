...
export function TwelveNationWorldOverview({ compact = false, target = "/simulation/world" }: { competitionId?: string; compact?: boolean; target?: string }) {

        ...
        <div className="mx-auto grid max-w-[1560px] gap-12 px-5 pb-20 pt-16 sm:px-8 lg:grid-cols-[1.03fr_.97fr] lg:px-12 lg:pb-28 lg:pt-24">
          <div className="relative z-10 max-w-4xl">
            ...
            <div className="mt-9 flex flex-col gap-3 sm:flex-row">
              ...
              <Link href="/daily-brief" className="home-secondary-action">Today’s Economic Brief <Newspaper size={16} /></Link>
            </div>
          </div>
          <HeroVisual />
        </div>
...
function HeroVisual() {
  return <div className="home-hero-visual" aria-label="Illustrated economics system"><div className="home-visual-grid" /><div className="home-visual-axis home-visual-axis-x" /><div className="home-visual-axis home-visual-axis-y" /><div className="home-curve home-curve-demand" /><div className="home-curve home-curve-supply" /><div className="home-equilibrium"><span>Equilibrium</span><i /></div><div className="home-is-lm"><b>IS</b><i>LM</i><span>r</span><em>Y</em></div><div className="home-network-mini">{Array.from({ length: 7 }, (_, index) => <i key={index} style={{ "--point": index } as React.CSSProperties} />)}</div><p className="home-visual-equation">Y = C + I + G + (X − M)</p><p className="home-visual-caption">Assumptions → mechanism → interpretation</p></div>;
}

...
revoke all on function public.can_read_research_paper(uuid, uuid), public.can_read_research_paper_file(text, uuid), public.create_research_paper(text, text, text, text, text, smallint, text, text, text, text, text, text, boolean), public.update_research_paper_submission(uuid, text, text, text, text, text, smallint, text, text, text, text, text, text), public.attach_research_paper_file(uuid, text, text, integer), public.review_research_paper(uuid, text, text, boolean, boolean) from public, anon, authenticated;
